          ...
          <v-card class="elevation-12">
            ...
            <v-card-text>
              <v-form>
                ...
                <div
                  id="g_id_onload"
                  data-client_id="747698519209-etdi5geinr3gh5mo8630b41ct4n0l2di.apps.googleusercontent.com"
...
export default defineComponent({
  ...
  setup() {
    ...
    const loginWithGoogleAccount = async () => {
      // const re = await app.$gAuth.signIn()
      // console.log(re)

      const re = await app.$auth.loginWith('google')
      console.log(re)
    }
