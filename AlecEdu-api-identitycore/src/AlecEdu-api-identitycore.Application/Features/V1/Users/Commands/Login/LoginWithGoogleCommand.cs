...
public class LoginWithGoogleCommand : IRequest<BaseResponse<LoginResultDto>>
{
    public UserLoginExternalDto Data { get; init; } = null!;
}

public class LoginWithGoogleCommandHandler : IRequestHandler<LoginWithGoogleCommand, BaseResponse<LoginResultDto>>
{
    ...
    public async Task<BaseResponse<LoginResultDto>> Handle(
        ...
        )
    {
        ...
        try
        {
            ...
            if (user != null)
            {
                ...
                _logger.LogInformation("LoginWithGoogleCommandHandler@Handle -- End");
                response.Data = token;
